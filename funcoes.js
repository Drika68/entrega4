function ExibirDados()
{
    ...
    var trechos;
    trechos = texto.split("<b>");
    console.log(trechos);

    alert (texto.substring(91, 103));
    var cidade1 = trechos[1].split("*") [1];
    console.log(cidade1);
    var roteirosa = trechos[1].split("#") [1];
    console.log(roteirosa);
    var roteirosb = trechos[1].split("#") [2];
    console.log(roteirosb);
    var roteirosc = trechos[1].split("#") [3];
    console.log(roteirosc);
    console.log(texto.substring(369, 430));
    console.log(texto.substring(447, 510));
    console.log(texto.substring(527, 614));
    

    alert(texto.substring(642, 653));
    var cidade2 = trechos[2].split("*") [1];
    console.log(cidade2);
    var roteiros2a = trechos[2].split("#") [1];
    console.log(roteiros2a);
    var roteiros2b = trechos[2].split("#") [2];
    console.log(roteiros2b);
    var roteiros2c = trechos[2].split("#") [3];
    console.log(roteiros2c);
    console.log(texto.substring(947, 1039));
    console.log(texto.substring(1056, 1145));
    console.log(texto.substring(1162, 1253));


    alert(texto.substring(1280, 1288));
    var cidade3 = trechos[3].split("*") [1];
    console.log(cidade3);
    var roteiros3a = trechos[3].split("#") [1];
    console.log(roteiros3a);
    var roteiros3b = trechos[3].split("#") [2];
    console.log(roteiros3b);
    var roteiros3c = trechos[3].split("#") [3];
    console.log(roteiros3c);
    console.log(texto.substring(1483, 1579));
    console.log(texto.substring(1596, 1663));
    console.log(texto.substring(1680, 1777));

    alert("Possuimos 3 opções para você: \n" + roteirosa);
    alert("Possuimos 3 opções para você: \n" + roteirosb);
    alert("Possuimos 3 opções para você: \n" + roteirosc);
    alert("Possuimos 3 opções para você: \n" + roteiros2a);
    alert("Possuimos 3 opções para você: \n" + roteiros2b);
